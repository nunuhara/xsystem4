...
//bool StoatSpriteEngine_ADVSceneKeeper_AddADVScene(ref struct pIVMStruct2);
//int StoatSpriteEngine_ADVSceneKeeper_GetNumofADVScene(void);
//bool StoatSpriteEngine_ADVSceneKeeper_GetADVScene(int nIndex, ref struct pIVMStruct2);
...
HLL_LIBRARY(StoatSpriteEngine,
	    ...
	    HLL_TODO_EXPORT(ADVSceneKeeper_AddADVScene, StoatSpriteEngine_ADVSceneKeeper_AddADVScene),
	    HLL_TODO_EXPORT(ADVSceneKeeper_GetNumofADVScene, StoatSpriteEngine_ADVSceneKeeper_GetNumofADVScene),
	    HLL_TODO_EXPORT(ADVSceneKeeper_GetADVScene, StoatSpriteEngine_ADVSceneKeeper_GetADVScene),
