...
HLL_LIBRARY(PartsEngine,
	    ...
	    HLL_TODO_EXPORT(AddMotionHGaugeRate, PartsEngine_AddMotionHGaugeRate),
	    HLL_TODO_EXPORT(AddMotionVGaugeRate, PartsEngine_AddMotionVGaugeRate),
	    HLL_TODO_EXPORT(AddMotionNumeralNumber, PartsEngine_AddMotionNumeralNumber),
	    HLL_TODO_EXPORT(AddMotionMagX, PartsEngine_AddMotionMagX),
	    HLL_TODO_EXPORT(AddMotionMagY, PartsEngine_AddMotionMagY),
	    HLL_TODO_EXPORT(AddMotionRotateX, PartsEngine_AddMotionRotateX),
	    HLL_TODO_EXPORT(AddMotionRotateY, PartsEngine_AddMotionRotateY),
	    HLL_TODO_EXPORT(AddMotionRotateZ, PartsEngine_AddMotionRotateZ),
	    ...
	    HLL_TODO_EXPORT(SetThumbnailReductionSize, PartsEngine_SetThumbnailReductionSize),
	    HLL_TODO_EXPORT(SetThumbnailMode, PartsEngine_SetThumbnailMode),
