...
#define YYSTYPE         TEXT_STYPE
/* Substitute the variable and function names.  */
#define yyparse         text_parse
#define yylex           text_lex
#define yyerror         text_error
#define yydebug         text_debug
#define yynerrs         text_nerrs

#define yylval          text_lval
#define yychar          text_char
...
# endif
     ...
     && (! defined __cplusplus \
         || (defined TEXT_STYPE_IS_TRIVIAL && TEXT_STYPE_IS_TRIVIAL)))
...
{
       0,    69,    69,    72,    73,    76,    77,    78
};
#endif

#if TEXT_DEBUG || YYERROR_VERBOSE || 0
/* YYTNAME[SYMBOL-NUM] -- String name of the symbol SYMBOL-NUM.
   First, the terminals, then, starting at YYNTOKENS, nonterminals.  */
static const char *const yytname[] =
{
  "$end", "error", "$undefined", "NEWLINE", "LBRACKET", "RBRACKET",
  "EQUAL", "MESSAGES", "STRINGS", "NUMBER", "STRING", "$accept", "program",
...
{
       1,     9,     7,     8,     2,     3,    17,     0,    13,    11,
      14,    12,    15,    16,    18,    19,    20,     0,     0,    10
};

static const yytype_int8 yycheck[] =
{
       3,     0,     4,     4,     7,     8,    10,    -1,     5,     9,
       5,     9,     6,     6,    10,     3,     3,    -1,    -1,     5
};
...
{
       0,     3,     7,     8,    12,    13,    14,     4,     4,     0,
      14,     9,     9,     5,     5,     6,     6,    10,    10,     3,
       3
};
