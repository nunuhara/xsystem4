...
//      TYPE   OPCODE          NR_ARGS, ARG_TYPES...
	...
	// FIXME: all types are guesses
        TODO ( SH_SR_ASSIGN, 0 ),
        TODO ( SH_MEM_ASSIGN_LOCAL, 2, T_INT, T_LOCAL ),
        TODO ( A_NUMOF_GLOB_1, 1, T_GLOBAL ),
        TODO ( A_NUMOF_STRUCT_1, 1, T_INT ),
        TODO ( SH_MEM_ASSIGN_IMM, 2, T_INT, T_INT ),
        TODO ( SH_LOCALREFREF, 1, T_LOCAL ),
        TODO ( SH_LOCALASSIGN_SUB_IMM, 2, T_INT, T_INT ),
        ...
        TODO ( SH_LOCALSTRUCT_ASSIGN_IMM, 0 ), // TODO: args?
        TODO ( SH_STRUCT_A_PUSHBACK_LOCAL_STRUCT, 2, T_INT, T_INT ),
        TODO ( SH_GLOBAL_A_PUSHBACK_LOCAL_STRUCT, 2, T_INT, T_INT ),
        TODO ( SH_LOCAL_A_PUSHBACK_LOCAL_STRUCT, 2, T_INT, T_INT ),
        TODO ( SH_IF_SREF_NE_STR0, 2, T_INT, T_ADDR ),
        TODO ( SH_S_ASSIGN_REF, 0 ),
        TODO ( SH_A_FIND_SREF, 0 ), // TODO: args?
        TODO ( SH_SREF_EMPTY, 0 ),
        TODO ( SH_STRUCTSREF_EQ_LOCALSREF, 2 , T_STRUCT, T_LOCAL ),
        TODO ( SH_LOCALSREF_EQ_STR0, 2, T_INT, T_INT ),
        TODO ( SH_STRUCTSREF_NE_LOCALSREF, 2, T_INT, T_INT ),
        ...
        TODO ( SH_LOCALREF_SASSIGN_LOCALSREF, 2, T_INT, T_INT ),
        TODO ( SH_LOCAL_APUSHBACK_LOCALSREF, 2, T_INT, T_INT ),
        TODO ( SH_S_ASSIGN_CALLSYS19, 0 ),
        TODO ( SH_S_ASSIGN_STR0, 1, T_INT ),
        TODO ( SH_SASSIGN_LOCALSREF, 1, T_INT ),
        TODO ( SH_STRUCTREF_SASSIGN_LOCALSREF, 2, T_INT, T_INT ),
        TODO ( SH_LOCALSREF_EMPTY, 1, T_INT ),
        TODO ( SH_GLOBAL_APUSHBACK_LOCALSREF, 2, T_INT, T_INT ),
        TODO ( SH_STRUCT_APUSHBACK_LOCALSREF, 2, T_INT, T_INT ),
        TODO ( SH_STRUCTSREF_EMPTY, 1, T_INT ),
        TODO ( SH_GLOBALSREF_EMPTY, 1, T_GLOBAL ),
        TODO ( SH_SASSIGN_STRUCTSREF, 1, T_INT ),
        TODO ( SH_SASSIGN_GLOBALSREF, 1, T_INT ),
        TODO ( SH_STRUCTSREF_NE_STR0, 2, T_INT, T_INT ),
        TODO ( SH_GLOBALSREF_NE_STR0, 2, T_INT, T_INT ),
        TODO ( SH_LOC_LT_IMM_OR_LOC_GE_IMM, 3, T_INT, T_ADDR, T_ADDR ),
